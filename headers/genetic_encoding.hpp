...
namespace ANN_USM{
	...
	class connection_gene{
		public:
			...
			*/
			void _connection_gene(int innovation, int in, int out, double weight, bool enable); // fill a conection gene
			/**
	...
	class node_gene{
		public:
			...
			*/
			void _node_genne(int node, gene_type type, int row, Return_random_function random_function);
			/**
